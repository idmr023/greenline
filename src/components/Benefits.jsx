...
const benefits = [
  {
    icon: HardHat,
    title: 'Casco básico incluido',
    text: 'En la compra de tu moto o VMP eléctrico.',
  },
  {
    icon: Wrench,
    title: '2 revisiones técnicas gratis',
    text: 'Mantenimiento preventivo sin costo el primer año.',
  },
  {
    icon: Truck,
  ...
  },
  {
    ...
    text: 'Cobertura de motor y batería con respaldo real.',
  },
];
