...
const PERMISSIONS = {
  ...
  // Blog
  'blog:read': [Rol.ADMIN, Rol.EDITOR_ARTICULOS, Rol.DESARROLLADOR_WEB, Rol.CLIENTE],
  'blog:create': [Rol.ADMIN, Rol.EDITOR_ARTICULOS, Rol.DESARROLLADOR_WEB],
  'blog:update': [Rol.ADMIN, Rol.EDITOR_ARTICULOS, Rol.DESARROLLADOR_WEB],
  'blog:delete': [Rol.ADMIN, Rol.EDITOR_ARTICULOS, Rol.DESARROLLADOR_WEB],
