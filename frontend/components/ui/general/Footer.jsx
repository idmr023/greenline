...
const socials = [
  { icon: faFacebookF, label: 'Facebook', link: 'https://www.facebook.com/GreenLinePeru/' },
  { icon: faInstagram, label: 'Instagram', link: 'https://www.instagram.com/greenline_peru/' },
  { icon: faYoutube, label: 'YouTube', link: 'https://www.youtube.com/@GreenLinePeru' },
  { icon: faLinkedinIn, label: 'LinkedIn', link: 'https://www.linkedin.com/company/greenline-peru/' },
  { icon: faTiktok, label: 'TikTok', link: 'https://www.tiktok.com/@greenline_peru' },
];
