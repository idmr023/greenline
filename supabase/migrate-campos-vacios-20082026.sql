...
UPDATE ficha_tecnica SET largo_cm = 332, ancho_cm = 130, alto_cm = 142 WHERE producto_id = 16;
...
UPDATE ficha_tecnica SET potencia_motor = '800W', potencia_bateria = '60V/23AH', velocidad_max_kmh = 22, autonomia_km = 35 WHERE producto_id = 14;

UPDATE ficha_tecnica SET potencia_motor = '500W', potencia_bateria = '60V/20AH', velocidad_max_kmh = 22, autonomia_km = 40 WHERE producto_id = 15;
...
UPDATE ficha_tecnica SET potencia_bateria = '72V/23AH', tipo_bateria = 'Plomo Grafeno', velocidad_max_kmh = 50, autonomia_km = 55 WHERE producto_id = 25;
