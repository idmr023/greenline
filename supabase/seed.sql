...
INSERT INTO ficha_tecnica (producto_id, potencia_motor,tipo_bateria,velocidad_max_kmh,autonomia_km) VALUES (5, '1000 watts, que te permite alcanzar velocidades de hasta 45 km/h. y con su batería de grafeno con capacidad de 72V 22Ah que te permitirá manejar distancias largas de 60 a 70 km por cada recarga y una durabilidad prolongada.','de grafeno con capacidad de 72V 22Ah que te permitirá manejar distancias largas de 60 a 70 km por cada recarga y una durabilidad prolongada.', 45, 60);
