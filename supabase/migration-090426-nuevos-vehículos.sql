...
INSERT INTO ficha_tecnica (producto_id, potencia_motor, potencia_bateria, tipo_bateria, velocidad_max_kmh, carga_maxima_kg, largo_cm, ancho_cm, alto_cm) VALUES ( (SELECT id FROM productos WHERE slug = 'greenline-gl4'), '3000W', '72V/38AH', 'Plomo Ácido', 75, 150, 176, 75, 106 ), ( (SELECT id FROM productos WHERE slug = 'greenline-m3-eco'), '1500W', '72V/38AH', 'Plomo Ácido', 75, 150, 176, 75, 106 );

INSERT INTO info_adicional (producto_id, data) VALUES ( (SELECT id FROM productos WHERE slug = 'greenline-gl4'), '{"Tipo de transmisión": "Automática", "Diferencial": "Sí", "Marcha en retroceso": "Sí", "Asientos / Pasajeros": "2 Asientos / 2 Pasajeros", "Tipo de moto": "Scooter", "Fórmula rodante": "2x1", "Llanta delantera/trasera": "120/70-12 / 120/70-10", "Largo*ancho*altura (cm)": "176 * 75 * 106", "Peso neto (kg)": "148 kg", "Peso bruto vehicular (kg)": "298 kg", "Peso soportado (kg)": "150 kg"}'::jsonb ), ( (SELECT id FROM productos WHERE slug = 'greenline-m3-eco'), '{"Tipo de transmisión": "Automática", "Diferencial": "Sí", "Marcha en retroceso": "Sí", "Asientos / Pasajeros": "2 Asientos / 2 Pasajeros", "Tipo de moto": "Scooter", "Fórmula rodante": "2x1", "Llanta delantera/trasera": "120/70-12 / 120/70-10", "Largo*ancho*altura (cm)": "176 * 75 * 106", "Peso neto (kg)": "148 kg", "Peso bruto vehicular (kg)": "298 kg", "Peso soportado (kg)": "150 kg"}'::jsonb );
...
BEGIN
    ...
    INSERT INTO imagenes (producto_id, url, color, es_principal, orden) VALUES (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_gris_costado.webp',   'Gris',  'true',  0), (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_gris_frontal.webp',   'Gris',  'false', 1), (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_gris_perfil.webp',    'Gris',  'false', 2), (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_gris_posterior.webp', 'Gris',  'false', 3), (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_negro_costado.webp',   'Negro',  'false', 4), (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_negro_frontal.webp',   'Negro',  'false', 5), (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_negro_perfil.webp',    'Negro',  'false', 6), (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_negro_posterior.webp', 'Negro',  'false', 7), (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_verde_costado.webp',   'Verde',  'false', 8), (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_verde_frontal.webp',   'Verde',  'false', 9), (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_verde_perfil.webp',    'Verde',  'false', 10), (gl4_id, IMAGE_BASE_URL || 'motos/gl4/gl4_verde_posterior.webp', 'Verde',  'false', 11);

    -- M3 ECO — 1 color × 4 vistas = 4 imágenes
    INSERT INTO imagenes (producto_id, url, color, es_principal, orden) VALUES (m3eco_id, IMAGE_BASE_URL || 'motos/m3eco/m3eco_gris_costado.webp',   'Gris', 'true',  0), (m3eco_id, IMAGE_BASE_URL || 'motos/m3eco/m3eco_gris_frontal.webp',   'Gris', 'false', 1), (m3eco_id, IMAGE_BASE_URL || 'motos/m3eco/m3eco_gris_perfil.webp',    'Gris', 'false', 2), (m3eco_id, IMAGE_BASE_URL || 'motos/m3eco/m3eco_gris_posterior.webp', 'Gris', 'false', 3);
END $$;